"""Run this paired comparison with the independently reusable LSTM32."""
import argparse
...
def main(limit=None, language='zh'):
    ...
    stages = [(ROOT / 'download_model.py', []), (ROOT / 'run_timesfm.py', [])]
    ...
    shared_args = ['--history', '32', '--language', language]
